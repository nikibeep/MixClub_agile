...
<body style="overflow: hidden;background-color: #eee;">
	...
	<div class="row">
	<h1 class="text-center" style="padding-top:25px;color: #000;font-weight: bold;font-size: 3.0em;">Mix Club <small>Agile</small></h1><br>
	...
	<div class="text-center" style="margin-top: 75px; color: #000;"><b>Made with <i style="color: red;">&#10084;</i> By Nikhil</a> 2022</b></div>
</body>
</html>