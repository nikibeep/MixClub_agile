	...
	if(isset($_POST['send_code']))
	{
		...
		if($rows == 1)
		{
			...
			if($rows == 1)
			{
				...
				$from = '<allmadhereveryday@gmail.com>';
				...
				$smtp = Mail::factory('smtp', array(
				        'host' => 'ssl://smtp.gmass.co',
				        'port' => '25',
				        'auth' => true,
				        'username' => 'gmass',
				        'password' => '19c4c3ed-151f-46f7-8642-664a023ed859'
				    ));
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<b><a class="navbar-brand" href="home.php"><span>Mix</span>Club</a></b>
				<ul class="user-menu">
 ...
 <b>Dashboard</b></a></li>
		...
		<div class="text-center" style="margin-top: 95px; color: #000;"><b>Made with <i style="color: red;">&#10084;</i> By <a href="" target="blank">Nikhil</a> 2022</b></div>
	</div><!--/.sidebar-->
